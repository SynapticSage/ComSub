...
plots.grm.barplot_property(T, "percMax_rrDim");
plots.grm.barplot_property(T, "rrDim", 'facet_by_animal', true, 'switch_facet', true);
plots.grm.barplot_property(T, "percMax_rrDim", 'facet_by_animal', true, 'switch_facet', true);

plots.grm.barplot_property(T, "first_comp_perf");
plots.grm.barplot_property(T, "second_comp_perf");
plots.grm.barplot_property(T, "full_model_performance");
plots.grm.barplot_property(T, "first_comp_perf", 'facet_by_animal', true, 'switch_facet', true);
plots.grm.barplot_property(T, "second_comp_perf", 'facet_by_animal', true, 'switch_facet', true);
plots.grm.barplot_property(T, "full_model_performance", 'facet_by_animal', true, 'switch_facet', true);
